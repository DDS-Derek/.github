...
- [Akimio521/MoviePilot-Plugins](https://github.com/Akimio521/MoviePilot-Plugins) - 第三方库 (1 day ago)
...
- [DDS-Derek/rtorrent-rutorrent-flood-Docker](https://github.com/DDS-Derek/rtorrent-rutorrent-flood-Docker) ([4.3.0-0.9.8_2-0.13.8_2](https://github.com/DDS-Derek/rtorrent-rutorrent-flood-Docker/releases/tag/4.3.0-0.9.8_2-0.13.8_2), today)
- [jxxghp/MoviePilot](https://github.com/jxxghp/MoviePilot) ([v1.8.4](https://github.com/jxxghp/MoviePilot/releases/tag/v1.8.4), today) - NAS媒体库自动化管理工具
- [jxxghp/MoviePilot-Frontend](https://github.com/jxxghp/MoviePilot-Frontend) ([v1.8.4](https://github.com/jxxghp/MoviePilot-Frontend/releases/tag/v1.8.4), today) - MoviePilot前端
- [amtoaer/bili-sync](https://github.com/amtoaer/bili-sync) ([v2.0.2](https://github.com/amtoaer/bili-sync/releases/tag/v2.0.2), 1 day ago) - 基于 rust tokio 编写的 bilibili 收藏夹同步下载工具。
...
- [Docker partial optimization](https://github.com/PBH-BTN/PeerBanHelper/pull/81) on [PBH-BTN/PeerBanHelper](https://github.com/PBH-BTN/PeerBanHelper) (1 day ago)
- [fix: requirements file path error](https://github.com/Akimio521/MoviePilot-Plugins/pull/1) on [Akimio521/MoviePilot-Plugins](https://github.com/Akimio521/MoviePilot-Plugins) (1 day ago)
...
- [feat: install the plug-in pip extension in advance](https://github.com/jxxghp/MoviePilot/pull/1789) on [jxxghp/MoviePilot](https://github.com/jxxghp/MoviePilot) (4 weeks ago)
...
- [【MoviePilot系列】常见问题及其解决办法 &amp; 部分自建功能教程](https://blog.ddsrem.com/archives/moviepilot-issue-solution-outorial) (7 months ago)
