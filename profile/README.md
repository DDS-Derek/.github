...
- [DDS-Derek/transmission-Docker](https://github.com/DDS-Derek/transmission-Docker) - A better transmission docker image (5 days ago)
...
- [DDS-Derek/Filebrowser-Docker](https://github.com/DDS-Derek/Filebrowser-Docker) ([v2.28.0](https://github.com/DDS-Derek/Filebrowser-Docker/releases/tag/v2.28.0), today) - A more easy-to-use filebrowser docker image
- [jxxghp/MoviePilot](https://github.com/jxxghp/MoviePilot) ([v1.7.8](https://github.com/jxxghp/MoviePilot/releases/tag/v1.7.8), 3 days ago) - NAS媒体库自动化管理工具
- [jxxghp/MoviePilot-Frontend](https://github.com/jxxghp/MoviePilot-Frontend) ([v1.7.8](https://github.com/jxxghp/MoviePilot-Frontend/releases/tag/v1.7.8), 3 days ago) - MoviePilot前端
...
- [feat: install the plug-in pip extension in advance](https://github.com/jxxghp/MoviePilot/pull/1789) on [jxxghp/MoviePilot](https://github.com/jxxghp/MoviePilot) (4 days ago)
