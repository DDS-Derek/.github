...
- [Akimio521/MoviePilot-Plugins](https://github.com/Akimio521/MoviePilot-Plugins) - 第三方库 (3 weeks ago)

#### 🔭 Latest releases I've contributed to

- [jxxghp/MoviePilot](https://github.com/jxxghp/MoviePilot) ([v1.8.8](https://github.com/jxxghp/MoviePilot/releases/tag/v1.8.8), 3 days ago) - NAS媒体库自动化管理工具
- [jxxghp/MoviePilot-Frontend](https://github.com/jxxghp/MoviePilot-Frontend) ([v1.8.8](https://github.com/jxxghp/MoviePilot-Frontend/releases/tag/v1.8.8), 3 days ago) - MoviePilot前端
- [amtoaer/bili-sync](https://github.com/amtoaer/bili-sync) ([v2.0.6](https://github.com/amtoaer/bili-sync/releases/tag/v2.0.6), 1 week ago) - 基于 rust tokio 编写的 bilibili 收藏夹同步下载工具。
...
- [DDS-Derek/rtorrent-rutorrent-flood-Docker](https://github.com/DDS-Derek/rtorrent-rutorrent-flood-Docker) ([4.3.0-0.9.8_3-0.13.8_2](https://github.com/DDS-Derek/rtorrent-rutorrent-flood-Docker/releases/tag/4.3.0-0.9.8_3-0.13.8_2), 2 weeks ago)

#### 🔨 Latest Pull Requests I published

- [bump: debian bullseye to bookworm](https://github.com/jxxghp/MoviePilot/pull/2056) on [jxxghp/MoviePilot](https://github.com/jxxghp/MoviePilot) (5 days ago)
- [feat: docker file structure organization](https://github.com/ledccn/iyuuplus-dev/pull/37) on [ledccn/iyuuplus-dev](https://github.com/ledccn/iyuuplus-dev) (6 days ago)
...
- [Docker partial optimization](https://github.com/PBH-BTN/PeerBanHelper/pull/81) on [PBH-BTN/PeerBanHelper](https://github.com/PBH-BTN/PeerBanHelper) (3 weeks ago)
