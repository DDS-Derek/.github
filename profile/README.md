...
- [xiaoyaDev/xiaoya_emd_go](https://github.com/xiaoyaDev/xiaoya_emd_go) - 小雅元数据爬虫Golang版 (1 week ago)
...
- [xiaoyaDev/xiaoya_db](https://github.com/xiaoyaDev/xiaoya_db) ([1.6.15](https://github.com/xiaoyaDev/xiaoya_db/releases/tag/1.6.15), 1 week ago) - 高速异步爬虫从 https://emby.xiaoya.pro/ 同步小雅元数据
...
- [DDS-Derek/Reader-Docker](https://github.com/DDS-Derek/Reader-Docker) ([v3.2.13](https://github.com/DDS-Derek/Reader-Docker/releases/tag/v3.2.13), 3 weeks ago) - 支持PUID，PGID，Umask设置的Reader镜像
...
- [fix(crossseed): missing a private property](https://github.com/jxxghp/MoviePilot-Plugins/pull/724) on [jxxghp/MoviePilot-Plugins](https://github.com/jxxghp/MoviePilot-Plugins) (3 weeks ago)
