...
- [jxxghp/MoviePilot-Frontend](https://github.com/jxxghp/MoviePilot-Frontend) ([v1.6.9](https://github.com/jxxghp/MoviePilot-Frontend/releases/tag/v1.6.9), 3 days ago) - MoviePilot前端
- [jxxghp/MoviePilot](https://github.com/jxxghp/MoviePilot) ([v1.6.8-fix](https://github.com/jxxghp/MoviePilot/releases/tag/v1.6.8-fix), 4 days ago) - NAS媒体库自动化管理工具
- [amtoaer/bili-sync](https://github.com/amtoaer/bili-sync) ([1.1.8](https://github.com/amtoaer/bili-sync/releases/tag/1.1.8), 6 days ago) - 基于 python asyncio 编写的 bilibili 收藏夹同步下载工具。
- [ngfchl/NewPtools](https://github.com/ngfchl/NewPtools) ([2024-02-21](https://github.com/ngfchl/NewPtools/releases/tag/2024-02-21), 1 week ago)
...
- [fix: plugin directory backup failed](https://github.com/jxxghp/MoviePilot/pull/1570) on [jxxghp/MoviePilot](https://github.com/jxxghp/MoviePilot) (2 days ago)
- [feat: startup and update script optimization](https://github.com/jxxghp/MoviePilot/pull/1503) on [jxxghp/MoviePilot](https://github.com/jxxghp/MoviePilot) (1 week ago)
- [docs: update &amp; provide free server](https://github.com/easychen/CookieCloud/pull/58) on [easychen/CookieCloud](https://github.com/easychen/CookieCloud) (2 weeks ago)
