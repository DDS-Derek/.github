...
- [xiaoyaDev/xiaoya_db](https://github.com/xiaoyaDev/xiaoya_db) - 高速异步爬虫从 https://emby.xiaoya.pro/ 同步小雅元数据 (2 weeks ago)
- [DDS-Derek/MoviePilot-Plugins](https://github.com/DDS-Derek/MoviePilot-Plugins) -  (3 weeks ago)
- [DDS-Derek/runlike-Docker](https://github.com/DDS-Derek/runlike-Docker) -  (4 weeks ago)

#### 🔭 Latest releases I've contributed to

- [lavie/runlike](https://github.com/lavie/runlike) ([v1.6.3](https://github.com/lavie/runlike/releases/tag/v1.6.3), 3 days ago) - Given an existing docker container, prints the command line necessary to run a copy of it.
- [xiaoyaDev/xiaoya_db](https://github.com/xiaoyaDev/xiaoya_db) ([1.6.3](https://github.com/xiaoyaDev/xiaoya_db/releases/tag/1.6.3), 1 week ago) - 高速异步爬虫从 https://emby.xiaoya.pro/ 同步小雅元数据
- [DDS-Derek/Filebrowser-Docker](https://github.com/DDS-Derek/Filebrowser-Docker) ([v2.32.0](https://github.com/DDS-Derek/Filebrowser-Docker/releases/tag/v2.32.0), 4 weeks ago) - A more easy-to-use filebrowser docker image
...
- [feat: added test for `--use-volume-id` parameter](https://github.com/lavie/runlike/pull/129) on [lavie/runlike](https://github.com/lavie/runlike) (4 weeks ago)
...
- [【MoviePilot系列】媒体目录精细化配置指南](https://blog.ddsrem.com/archives/mediadirconfig) (9 months ago)
