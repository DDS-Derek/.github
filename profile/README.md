...
- [jxxghp/MoviePilot](https://github.com/jxxghp/MoviePilot) ([v1.9.3](https://github.com/jxxghp/MoviePilot/releases/tag/v1.9.3), 5 days ago) - NAS媒体库自动化管理工具
...
- [amtoaer/bili-sync](https://github.com/amtoaer/bili-sync) ([v2.0.7](https://github.com/amtoaer/bili-sync/releases/tag/v2.0.7), 1 week ago) - 基于 rust tokio 编写的 bilibili 收藏夹同步下载工具。
