...
- [jxxghp/MoviePilot-Frontend](https://github.com/jxxghp/MoviePilot-Frontend) ([v1.8.7-1](https://github.com/jxxghp/MoviePilot-Frontend/releases/tag/v1.8.7-1), 1 day ago) - MoviePilot前端
- [jxxghp/MoviePilot](https://github.com/jxxghp/MoviePilot) ([v1.8.7](https://github.com/jxxghp/MoviePilot/releases/tag/v1.8.7), 2 days ago) - NAS媒体库自动化管理工具
- [amtoaer/bili-sync](https://github.com/amtoaer/bili-sync) ([v2.0.6](https://github.com/amtoaer/bili-sync/releases/tag/v2.0.6), 6 days ago) - 基于 rust tokio 编写的 bilibili 收藏夹同步下载工具。
...
- [fix: docker build failed](https://github.com/ledccn/iyuuplus-dev/pull/3) on [ledccn/iyuuplus-dev](https://github.com/ledccn/iyuuplus-dev) (3 weeks ago)
